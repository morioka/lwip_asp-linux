...
/*	スタック領域の底 */
#define DEFAULT_ISTK_BOTTOM		INNER_RAM_END
...
#else				/*	HEWでデバッグする場合  */
#define STBCR2_VALUE	 (/* STBCR2_HUDI | STBCR2_DMAC | STBCR2_FPU */0)
#endif
	 ...
	 *	・リアルタイムクロックは動作
	 */
#define STBCR3_VALUE	 (/* STBCR3_HZ | */ STBCR3_IEBC | STBCR3_MTU2 | STBCR3_SDHC0 \
						  | STBCR3_SDHC1 | STBCR3_ADC | STBCR3_RTC)
	 ...
	 *	・SCFI7は停止
	 */
#define STBCR4_VALUE	 (STBCR4_SCIF0 | STBCR4_SCIF1 /* | STBCR4_SCIF2 */ | STBCR4_SCIF3 \
						  | STBCR4_SCIF4 | STBCR4_SCIF5 | STBCR4_SCIF6 | STBCR4_SCIF7)

	/*
	 *	・FIFO付きクロック同期シリアルI/Oは停止
	 *	・ルネサスSPDIFインタフェースは停止
	 *	・ビデオディスプレイコントローラ3は停止
	 *	・CMTは動作
	 *	・NANDフラッシュメモリコントローラは停止
	 */
#define STBCR7_VALUE	 (STBCR7_SIOF | STBCR7_SPDIF | STBCR7_VDC3 \
						  | /* STBCR7_CMT | */ STBCR7_FLC)

/*
 *  割込み許可が有効になるまでの時間待ちをするためのnop命令
 *  
 *  　SH7262は一般的なキャッシュを内蔵していない代わりに、
