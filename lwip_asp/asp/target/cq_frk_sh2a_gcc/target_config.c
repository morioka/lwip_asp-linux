...
target_initialize(void)
{
	 ...
	 *	LED接続ポートの初期化
	 */
	sil_wrh_mem((void *)PCIOR0, sil_reh_mem((void *)PCIOR0) | 0x0100U);
	sil_wrh_mem((void *)PCCR2, sil_reh_mem((void *)PCCR2) & ~0x0003U);
	
	/*
	 *	SCIF2のI/Oポートの設定
	 */
	sil_wrh_mem((void *)PFCR0, ((sil_reh_mem((void *)PFCR0) & ~0x0ff0) | 0x0440U));	/* SCIF2 -TR- */
